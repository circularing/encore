...
:build_plat
	...
	set GOARCH=amd64
	echo [+] Building
	go build -tags load_wintun_from_rsrc -ldflags "-X 'github.com/circularing/encore/internal/version.Version=v%ENCORE_VERSION%'" -o "%DST%\bin\encore.exe" "%ROOT%\cli\cmd\encore" || exit /b 1
